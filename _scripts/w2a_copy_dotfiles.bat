...
set "FILES[4]=notepadpp\NppExec.ini|%USERPROFILE%\scoop\apps\notepadplusplus\current\plugins\Config\NppExec.ini"
set "FILES[5]=notepadpp\Gruvbox dark medium.xml|%USERPROFILE%\scoop\apps\notepadplusplus\current\themes\Gruvbox dark medium.xml"
set "FILES[6]=notepadpp\Gruvbox light medium.xml|%USERPROFILE%\scoop\apps\notepadplusplus\current\themes\Gruvbox light medium.xml"
set "FILES[7]=startup.bat|%USERPROFILE%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\startup.bat"
set "FILES[8]=settings.json|%USERPROFILE%\scoop\apps\windows-terminal\current\settings\settings.json"
set "FILES[9]=config\git\config|%USERPROFILE%\.config\git\config"
...
set "FILES[13]=config\vim\.vimrc|%USERPROFILE%\.vimrc"
set "FILES[14]=vscode\settings.json|%USERPROFILE%\scoop\persist\vscode\data\user-data\User\settings.json"
set "FILES[15]=vscode\keybindings.json|%USERPROFILE%\scoop\persist\vscode\data\user-data\User\keybindings.json"
set "FILES[16]=vscode\extensions_vscode.txt|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.txt"
set "FILES[17]=autohotkey\Autohotkey64.ahk|%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\Autohotkey64.ahk"
set "FILES[18]=Microsoft.PowerShell_profile.ps1|%USERPROFILE%\Documents\PowerShell\Microsoft\PowerShell_profile.ps1"
set "FILES[19]=profile.ps1|%USERPROFILE%\Documents\PowerShell\profile.ps1"
set "FILES[20]=drawio\config.json|%APPDATA%\draw.io\config.json"
set "FILES[21]=office\Blank.potx|%APPDATA%\Microsoft\Templates\Blank.potx"
set "FILES[22]=office\PowerPoint.exportedUI|%LOCALAPPDATA%\Microsoft\Office\PowerPoint.officeUI"
set "FILES[23]=office\Book.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Book.xltx"
set "FILES[24]=office\Sheet.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Sheet.xltx"
set "FILES[25]=office\Excel.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Excel.officeUI"
set "FILES[26]=office\Normal.dotm|%APPDATA%\Microsoft\Templates\Normal.dotm"
set "FILES[27]=office\Word.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Word.officeUI"
set "FILES[28]=freecommander.ini|%USERPROFILE%\scoop\apps\freecommander\current\Settings\freecommander.ini"
set "MAX_IDX=28
...
rem set "FILES[19]=typora\conf.user.json|%APPDATA%\Typora\conf\conf.user.json"
rem set "FILES[20]=typora\themes|%APPDATA%\Typora\themes"
