...
set "FILES[4]=notepadpp\Gruvbox dark medium.xml|%USERPROFILE%\scoop\apps\notepadplusplus\current\themes\Gruvbox dark medium.xml"
set "FILES[5]=notepadpp\Gruvbox light medium.xml|%USERPROFILE%\scoop\apps\notepadplusplus\current\themes\Gruvbox light medium.xml"
...
set "FILES[9]=home\.gitconfig|%USERPROFILE%\.gitconfig"
set "FILES[10]=home\.gitignore_global|%USERPROFILE%\.gitignore_global"
...
set "FILES[18]=drawio\config.json|%APPDATA%\draw.io\config.json"
set "FILES[19]=office\Blank.potx|%APPDATA%\Microsoft\Templates\Blank.potx"
set "FILES[20]=office\PowerPoint.exportedUI|%LOCALAPPDATA%\Microsoft\Office\PowerPoint.officeUI"
set "FILES[21]=office\Book.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Book.xltx"
set "FILES[22]=office\Sheet.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Sheet.xltx"
set "FILES[23]=office\Excel.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Excel.officeUI"
set "FILES[24]=office\Normal.dotm|%APPDATA%\Microsoft\Templates\Normal.dotm"
set "FILES[25]=office\Word.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Word.officeUI"
set "MAX_IDX=25
