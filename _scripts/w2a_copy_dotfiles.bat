...
set "FILES[13]=vscode\settings.json|%USERPROFILE%\scoop\persist\vscode\data\user-data\User\settings.json"
set "FILES[14]=vscode\keybindings.json|%USERPROFILE%\scoop\persist\vscode\data\user-data\User\keybindings.json"
set "FILES[15]=vscode\extensions_vscode.txt|%USERPROFILE%\scoop\persist\vscode\data\extensions\extensions.txt"
set "FILES[16]=autohotkey\Autohotkey64.ahk|%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\Autohotkey64.ahk"
set "FILES[17]=Microsoft.PowerShell_profile.ps1|%USERPROFILE%\Documents\PowerShell\Microsoft\PowerShell_profile.ps1"
set "FILES[18]=profile.ps1|%USERPROFILE%\Documents\PowerShell\profile.ps1"
set "FILES[19]=drawio\config.json|%APPDATA%\draw.io\config.json"
set "FILES[20]=office\Blank.potx|%APPDATA%\Microsoft\Templates\Blank.potx"
set "FILES[21]=office\PowerPoint.exportedUI|%LOCALAPPDATA%\Microsoft\Office\PowerPoint.officeUI"
set "FILES[22]=office\Book.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Book.xltx"
set "FILES[23]=office\Sheet.xltx|%APPDATA%\Microsoft\Excel\XLSTART\Sheet.xltx"
set "FILES[24]=office\Excel.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Excel.officeUI"
set "FILES[25]=office\Normal.dotm|%APPDATA%\Microsoft\Templates\Normal.dotm"
set "FILES[26]=office\Word.exportedUI|%LOCALAPPDATA%\Microsoft\Office\Word.officeUI"
set "MAX_IDX=26
